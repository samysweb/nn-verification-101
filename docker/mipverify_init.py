# Modified version of https://github.com/dlshriver/dnnv/blob/main/dnnv/verifiers/mipverify/__init__.py
...
class MIPVerify(Verifier):
    ...
    parameters = {
        ...
        "tightening": Parameter(
            str,
            choices=["interval_arithmetic", "lp", "mip"],
            default="mip",
            help="The bound tightening technique to use (default: MIP).",
        ),
    }
    ...
    def build_inputs(self, prop):
        ...
        mipverify_inputs = to_mipverify_inputs(
            ...
            ubs,
            robustness_op_graph,
            tightening_algorithm=self.parameter_values["tightening"],
